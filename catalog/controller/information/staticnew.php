<?php
class ControllerInformationStaticnew extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('information/staticnew');

		$this->document->setTitle($this->language->get('heading_title'));

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->load->model('catalog/information'); 
			$this->model_catalog_information->addStaticData($this->request->post);
			exit;
			$this->response->redirect($this->url->link('information/success', '', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('information/staticnew')
		);
		...
		$data['text_staticnew'] = $this->language->get('text_staticnew');
		...
		$data['action'] = $this->url->link('information/staticnew', '', true);
